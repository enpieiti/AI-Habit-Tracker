...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <button onClick={toggle} className="fixed top-4 right-4 p-2.5 rounded-xl glass" aria-label="Toggle theme">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-7">
          ...
          <div className="text-center mt-5 text-sm text-soft ">
            <p className="text-sm text-muted mt-1">Email: test.user@gmail.com</p>
            <p className="text-sm text-muted mt-1">Password: password123</p>
          </div>
        </div>
      </div>
    </div>
