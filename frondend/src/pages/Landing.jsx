...
import { Sparkles, Flame, BarChart3, Brain, CheckCircle2, ArrowRight, Target, Activity, Sun, Moon } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-6 items-center">
          <div className="lg:col-span-8 text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="mt-5 text-soft text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              Track your habits, watch your streaks grow, and let AI turn your data into real encouragement — not
              generic motivation.
            </p>
        ...
        <div className="mt-14 md:mt-20 grid md:grid-cols-2 gap-6">
          <div className="card p-6 relative overflow-hidden">
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  <span className="w-9 h-9 rounded-lg bg-brand-500/15 flex items-center justify-center">{h.icon}</span>
          ...
          <div className="card p-6 relative overflow-hidden">
            <div
              ...
              style={{
                background: "radial-gradient(circle at 0% 0%, rgba(99,102,241,0.22), transparent 55%)",
              }}
            />
            <div className="relative">
              ...
              <p className="text-sm leading-relaxed">
                Big week for hydration — 7/7 on <b>Drink 2L water</b>! Your morning runs slipped to 3/5 on weekdays.
                Consistency pattern: you're strongest Mon–Wed. Try prepping shoes by the door tonight to protect
                tomorrow's momentum. Proud of you.
              </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="relative p-10 text-center rounded-2xl overflow-hidden bg-gradient-to-br from-brand-600 to-brand-900 text-white shadow-2xl shadow-brand-500/30">
          ...
          <div className="relative">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">Your first streak is 3 clicks away.</h2>
